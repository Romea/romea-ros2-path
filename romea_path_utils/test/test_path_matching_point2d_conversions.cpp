...
TEST(TestMatchingPoint2DConvertion, fromRosMsgToRomea )
{
  ...
  romea::PathMatchedPoint2D romea_path_matching_point=romea::to_romea(ros_path_matching_point2d_msg);

  EXPECT_EQ(romea_path_matching_point.sectionIndex,ros_path_matching_point2d_msg.section_index);
  EXPECT_EQ(romea_path_matching_point.curveIndex,ros_path_matching_point2d_msg.curve_index);
  EXPECT_DOUBLE_EQ(romea_path_matching_point.desiredSpeed,ros_path_matching_point2d_msg.desired_speed);
  EXPECT_DOUBLE_EQ(romea_path_matching_point.futureCurvature,ros_path_matching_point2d_msg.future_curvature);
